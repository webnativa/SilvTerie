    ...
    <table style="margin-top: 10px" id="sample-table-1" class="table table-striped table-bordered table-hover">
        ...
        <tr>
            <td width="9%"><span class="red"> * </span>  Texto:<br>
                <textarea rows="5" cols="10" style="width:100%" name="texto" required="true"><?= field_form($obj['texto']) ?></textarea>
                <br><br> <?php echo getCampos($conn, $obj['id'], 'texto' , $style = 'ckeditor'); ?>
            </td>
        </tr>
        <tr>
            <td width="9%"> <span class="red"> * </span> Nome do cliente <br>
                <input type="text" name="sintese" size="65" required="true" value="<?= field_form($obj['titulo']) ?>" />
                <br><br> <?php echo getCampos($conn, $obj['id'], 'titulo' , $style = false); ?>
            </td>
		</tr> 
        <!-- <tr>
        ...
        <tr>
            <td width="9%">Publicar?<br><input type="checkbox" name="status" value="1" checked <?php if (field_form($obj['status'])) echo 'checked'; ?> /></td>
        </tr>
        <tr>
            <td width="9%"><br>
