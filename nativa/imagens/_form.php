...
<form method="post" action="<?= _ROUTE_ACTION_ ?>/admin.php" enctype="multipart/form-data">
    ...
    <table style="margin-top: 10px" id="sample-table-1" class="table table-striped table-bordered table-hover">
        <tr>
            <td width="9%"> <span class="red"> * </span> T&iacute;tulo: <br> <input type="text" name="titulo" size="65" required="true" value="<?= field_form($obj['titulo']) ?>" /></td>
        </tr>

        <tr>
            <td width="9%">Status?<br><input type="checkbox" name="status" value="1" <?php if (field_form($obj['status'])) echo 'checked'; ?> /></td>
        </tr>
        ...
        <tr>
            <td width="9%"><span class="red"> * </span>  S&iacute;ntese:<br><input type="text" name="sintese" size="65" value="<?= field_form($obj['sintese']) ?>" /></td>
        </tr>

        <tr>
            <td width="9%"><span class="red"> * </span>  Texto:<br><textarea rows="5" cols="10" name="texto" required="true" class="ckeditor"><?= field_form($obj['texto']) ?></textarea></td>
        </tr>
